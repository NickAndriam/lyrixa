...
const useSwipeUpDown = (elementHeight: number, originalY: number = 0) => {
  ...
  // Add this to make sure children elements can receive touch events
  panHandlers.onStartShouldSetResponderCapture = () => true;
  panHandlers.onMoveShouldSetResponderCapture = () => false;
